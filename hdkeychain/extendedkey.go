...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := vtcutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*vtcutil.AddressPubKeyHash, error) {
	pkHash := vtcutil.Hash160(k.pubKeyBytes())
	return vtcutil.NewAddressPubKeyHash(pkHash, net)
}
