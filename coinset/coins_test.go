...
func NewCoin(index int64, value vtcutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = vtcutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = vtcutil.NewTxFromBytes(testSimpleCoinTxBytes)
